...
Rust-библиотека, используемая ipado3_back, ipado3_front, ipado3_agent. Содержит описания структур общие для всех программных компонент, в частности структур websocket-сообщений
